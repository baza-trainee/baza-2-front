...
export const patternNikDiscord = /^[A-z][A-z0-9_.]{1,31}$/i;

export const patternCountry = /^(?:|(?!.*[\u0401\u0451\u042B\u044B\u042D\u044D\u042A\u044A])[\p{L}]{4,30}(?:[\p{L} `’'”-]{4,50}[\p{L}])?)$/ugi;

export const patternСity = /^(?:|(?!.*[\u0401\u0451\u042B\u044B\u042D\u044D\u042A\u044A])[\p{L}]{2,30}(?:[\p{L} `’'”-]{2,50}[\p{L}])?)$/ugi;
